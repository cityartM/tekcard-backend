...
<head><base href=""/>
    ...
    <link rel="icon" type="image/png" href="{{ url('assets/media/logos/tekCard.png') }}" sizes="32x32" />
    <link rel="icon" type="image/png" href="{{ url('assets/media/logos/tekCard.png') }}" sizes="16x16" />
