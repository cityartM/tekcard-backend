...
import { A as ApplicationLogo } from "./ApplicationLogo-015a1322.mjs";
import { Link } from "@inertiajs/react";
import { N as NavLink } from "./NavLink-4a314f9d.mjs";
const UsersIcon = ({ size = 6 }) => {
  const className = `w-${size} h-${size} fill-current`;
  return /* @__PURE__ */ jsxs("svg", { className, viewBox: "0 0 24 24", children: [
    /* @__PURE__ */ jsx("path", { d: "M15.8513 11.6882C16.0596 11.7921 16.372 11.7921 16.6845 11.7921C18.5591 11.7921 20.1213 10.2337 20.1213 8.36353C20.1213 6.49341 18.5591 4.93496 16.6845 4.93496C16.5803 4.93496 16.5803 4.93496 16.4762 4.93496C17.1011 5.76613 17.4135 6.80509 17.4135 7.94795C17.4135 9.2986 16.8928 10.6492 15.8513 11.6882Z" }),
    /* @__PURE__ */ jsx("path", { d: "M18.0383 13.1429H17.3093C18.6632 14.1819 19.4964 15.8442 19.4964 17.7143C19.4964 18.1299 19.3922 18.5455 19.2881 18.9611C20.3295 18.7533 20.9544 18.5455 21.371 18.3377C21.7876 18.1299 21.9959 17.6104 21.9959 17.091C22.1 14.9091 20.2254 13.1429 18.0383 13.1429Z" }),
    /* @__PURE__ */ jsx("path", { d: "M7.31142 11.7923C7.62386 11.7923 7.83215 11.7923 8.14458 11.6884C7.20728 10.6494 6.58241 9.40265 6.58241 7.84421C6.58241 6.70135 6.89484 5.66239 7.51971 4.83122C7.51971 4.83122 7.41557 4.83122 7.31142 4.83122C5.43681 4.83122 3.87463 6.38966 3.87463 8.25979C3.87463 10.1299 5.33267 11.7923 7.31142 11.7923Z" }),
    /* @__PURE__ */ jsx("path", { d: "M6.58238 13.1429H5.95751C3.77047 13.1429 2 14.9091 2 17.091C2 17.6104 2.20829 18.1299 2.62487 18.3377C3.04145 18.5455 3.66632 18.8572 4.70777 18.9611C4.60363 18.5455 4.49948 18.1299 4.49948 17.7143C4.49948 15.9481 5.2285 14.2858 6.58238 13.1429Z" }),
    /* @__PURE__ */ jsx("path", { d: "M9.60264 10.8571C10.2275 11.3766 11.0607 11.6883 11.998 11.6883C12.9353 11.6883 13.7684 11.3766 14.3933 10.8571C15.3306 10.1299 15.8513 9.09091 15.8513 7.84416C15.8513 6.90909 15.5389 5.97403 14.914 5.35065C14.185 4.51948 13.1436 4 11.998 4C10.8524 4 9.70679 4.51948 9.08192 5.35065C8.45705 5.97403 8.04047 6.90909 8.04047 7.84416C8.04047 9.09091 8.66534 10.1299 9.60264 10.8571Z" }),
    /* @__PURE__ */ jsx("path", { d: "M14.0807 13.3506C13.8724 13.3506 13.6642 13.3506 13.4559 13.3506H10.3315C10.1232 13.3506 9.91493 13.3506 9.70664 13.3506C7.51959 13.6623 5.85327 15.5325 5.85327 17.7143C5.85327 18.3377 6.16571 18.8571 6.58229 19.0649C7.3113 19.4805 8.76933 20 11.7895 20C14.8097 20 16.2678 19.4805 16.9968 19.0649C17.5175 18.7532 17.7258 18.2338 17.7258 17.7143C18.0382 15.5325 16.2678 13.6623 14.0807 13.3506Z" })
  ] });
};
const BarsIcon = ({ size = 6 }) => {
  const className = `w-${size} h-${size} fill-current`;
  return /* @__PURE__ */ jsx("svg", { className, viewBox: "0 0 448 512", children: /* @__PURE__ */ jsx("path", { d: "M0 96C0 78.3 14.3 64 32 64H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H416c17.7 0 32 14.3 32 32z" }) });
};
const navigation = [
  {
    label: "Home",
...
const Header = ({}) => {
  return /* @__PURE__ */ jsxs("header", { children: [
    /* @__PURE__ */ jsx("div", { className: "md:hidden block py-6 w-full", children: /* @__PURE__ */ jsxs("div", { className: "px-6 flex items-center justify-between", children: [
  ...
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
    ...
    /* @__PURE__ */ jsx(
      "footer",
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: " max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-7 gap-20", children: [
          /* @__PURE__ */ jsxs("div", { className: "col-span-2 flex flex-col gap-8", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-[1.28rem] font-normal leading-10", children: "Lorem ipsum dolor sitonsecteturadipisicing elit sed do eiusmod temporincididunt Laoreet non sagittis aliquam bibendum." }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6", children: [
              /* @__PURE__ */ jsxs("svg", { width: "23", height: "22", viewBox: "0 0 23 22", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
                /* @__PURE__ */ jsx(
                  "path",
                  {
                    d: "M15.766 1.95073C16.9948 1.95426 18.1723 2.42555 19.0411 3.26167C19.91 4.09778 20.3998 5.23079 20.4035 6.41323V15.3373C20.3998 16.5197 19.91 17.6527 19.0411 18.4888C18.1723 19.325 16.9948 19.7962 15.766 19.7998H6.49213C5.26333 19.7962 4.08591 19.325 3.21701 18.4888C2.34812 17.6527 1.85835 16.5197 1.85468 15.3373V6.41323C1.85835 5.23079 2.34812 4.09778 3.21701 3.26167C4.08591 2.42555 5.26333 1.95426 6.49213 1.95073H15.766ZM15.766 0.166016H6.49213C2.92138 0.166016 0 2.97719 0 6.41323V15.3373C0 18.7733 2.92138 21.5845 6.49213 21.5845H15.766C19.3368 21.5845 22.2582 18.7733 22.2582 15.3373V6.41323C22.2582 2.97719 19.3368 0.166016 15.766 0.166016Z",
                    fill: "#2273AF"
                  }
                ),
                /* @__PURE__ */ jsx(
              ...
              /* @__PURE__ */ jsx("svg", { width: "27", height: "20", viewBox: "0 0 27 20", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsx(
                "path",
                {
          ...
          /* @__PURE__ */ jsxs("div", { className: "col-span-full md:col-span-5 grid grid-cols-1 md:grid-cols-3 gap-y-8 gap-x-18", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx(
                ...
                {
                  type: "button",
                  className: "mt-6 flex-shrink-0 px-[1.5rem] py-[0.5rem] w-full md:w-auto h-[2.5rem] rounded-[4.5rem] bg-[#2273AF] text-white",
