...
import { L as LandingLayout, D as DummySponsorIcon } from "./LandingLayout-5cee512a.mjs";
...
const HeroSection = () => {
  usePage().props;
  const __ = (key) => key;
  return /* @__PURE__ */ jsx("section", { className: "max-w-7xl mx-auto py-20 px-24", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-4 grid-rows-1 gap-x-6 items-stretch", children: [
