    ...
    post && /* @__PURE__ */ jsxs(Section, { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative w-full grid grid-cols-1 lg:grid-cols-7 gap-10", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-16 lg:mt-20 col-span-full lg:col-span-2 flex-shrink-0 max-w-xl", children: [
          /* @__PURE__ */ jsx("div", { className: "mb-10 flex flex-col space-y-4", children: /* @__PURE__ */ jsx(
            TextInput,
            {
              id: "search",
              type: "text",
...
const PostList = ({ posts }) => {
  return /* @__PURE__ */ jsx("div", { className: "space-y-8 lg:space-y-10", children: posts.map((post) => /* @__PURE__ */ jsxs("article", { className: "relative isolate flex flex-col gap-8 lg:flex-row", children: [
