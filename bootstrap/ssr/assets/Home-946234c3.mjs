  ...
  return /* @__PURE__ */ jsxs(LandingLayout, { children: [
    ...
    /* @__PURE__ */ jsx(HomeSection, { className: "bg-sky-200 bg-gradient-to-r from-pink-200 to-pink-100 border border-black", children: /* @__PURE__ */ jsxs("div", { className: "min-h-full h-full p-4 grid grid-cols-1 lg:grid-cols-2 gap-10", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-center space-y-8", children: [
        ...
        /* @__PURE__ */ jsx("a", { href: "#", className: "block text-[#44C8EF] text-[1.25rem] font-normal", children: "Learn more about our digital business cards →" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "hidden lg:block relative m-12 h-[50vh] bg-gradient-to-r from-sky-200 to-sky-100 rounded-2xl", children: /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 top-1/4 flex justify-center gap-12", children: [
