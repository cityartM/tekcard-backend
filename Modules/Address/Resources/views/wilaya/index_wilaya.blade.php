...
@section('breadcrumbs')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        <li class="breadcrumb-item text-muted">
            <a href="" class="text-muted text-hover-primary">@lang('app.wilaya')</a>
        </li>
        <li class="breadcrumb-item">
            <span class="bullet bg-gray-400 w-5px h-2px"></span>
        </li>
        <li class="breadcrumb-item text-muted">@lang('app.wilaya')</li>
    </ul>
@stop

@section('content')
    @section('actions')
        <a href="{{ route('address.create') }}" class="btn btn-sm btn-primary">
