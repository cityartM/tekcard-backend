...
@section('breadcrumbs') 
    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">@lang('app.subscription')</h1>
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        <li class="breadcrumb-item text-muted">
            <a href="" class="text-muted text-hover-primary">@lang('app.subscription_list')</a>
        </li>
    </ul>
@stop

@section('actions')
    <a href="{{ route('sub.download') }}" class="btn btn-sm btn-primary">
        <i class="ki-duotone ki-plus-square fs-3 ml-2 mr-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
        @lang('app.downlaod data')
    </a>
@endsection
