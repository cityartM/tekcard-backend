...
@section('page-heading', __('app.setting_contact'))
...
@section('breadcrumbs')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        <li class="breadcrumb-item text-muted">
            <a href="" class="text-muted text-hover-primary">@lang('app.setting_contact_list')</a>
        </li>
    </ul>
@stop
@section('actions')
    <a href="{{ route('settingContacts.create') }}" class="btn btn-sm btn-primary">
        <i class="ki-duotone ki-plus-square fs-3 ml-2 mr-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
        @lang('app.add_setting_contact')
    </a>
@endsection
...
@section('scripts')
    ...
    <x-datatable.script
        :columns="$columns"
        :route="route('settingContacts.index')"
    />
    <script>
        "use strict";
        $(function () {
