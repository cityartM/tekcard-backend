...
@section('page-title', __('app.user_contacts'))
@section('page-heading', __('app.user_contacts'))

@section('breadcrumbs')
    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">@lang('app.user_contacts')</h1>
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        <li class="breadcrumb-item text-muted">
            <a href="" class="text-muted text-hover-primary">@lang('app.user_contacts_list')</a>
        </li>
    </ul>
@stop
@section('content')
...
<script src={{ asset('assets/plugins/custom/datatables/datatables.bundle.js') }}></script>
    <x-datatable.script
        :columns="$columns"
        :route="route('userContacts.index')"
    />
    <script>
        "use strict";
        $(function () {
