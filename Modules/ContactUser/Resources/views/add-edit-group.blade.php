...
@section('breadcrumbs')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            ...
            <li class="breadcrumb-item text-dark">
                <a href="{{ route('groups.index') }}">@lang('app.group')</a>
            </li>
...
@if ($edit)
    {{ html()->form('PUT',route('groups.update', $group))->class('form w-100')->id('group-form')->attribute('enctype', 'multipart/form-data')->open() }}
@else
    {{ html()->form('POST',route('groups.store'))->class('form w-100')->id('group-form')->attribute('enctype', 'multipart/form-data')->open() }}
@endif
