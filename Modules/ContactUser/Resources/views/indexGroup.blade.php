...
@section('page-title', __('app.groups'))
@section('page-heading', __('app.groups'))

@section('breadcrumbs')
    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">@lang('app.groups')</h1>
