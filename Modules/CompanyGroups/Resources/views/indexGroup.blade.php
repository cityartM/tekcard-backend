...
@section('page-heading', __('app.company_groups'))

@section('breadcrumbs')
    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">@lang('app.company_groups')</h1>
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        <li class="breadcrumb-item text-muted">
            <a href="" class="text-muted text-hover-primary">@lang('app.groups_list')</a>
        </li>
    </ul>
@stop
@section('actions')
    <a href="{{ route('companygroups.create') }}" class="btn btn-sm btn-primary">
...
@section('scripts')
    ...
    <x-datatable.script
        :columns="$columns"
        :route="route('companygroups.index')"
    />
    <script>
        "use strict";
        $(function () {
