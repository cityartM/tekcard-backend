    ...
    public function run()
    {
        ...
        $blogs = [
            [
                ...
                'text' => [
                    'en' => "<p style='text-align: left;'><span>Illo sint voluptas. Error voluptates culpa eligendi. Hic vel totam vitae illo. Non aliquid explicabo necessitatibus unde. Sed exercitationem placeat consectetur nulla deserunt vel. Iusto corrupti dicta.</span></p>",
                    'ar' => "<p style='text-align: left;'><span>دعهم يكون من دواعي سروره. إنه خطأ اختيار الملذات الخاطئة. هنا أو طوال حياته. لن أشرح أي شيء عما يجب القيام به. ولكن يجب أن يتبع التدريب عدم الهجر أيضًا. وقيل أنه مجرد فاسد.</span></p>",
                    'tr' => "<p style='text-align: left;'><span>Bırakın bunlar onun zevki olsun. Yanlış zevkleri seçmek hatadır. Burada ya da tüm hayatı boyunca. Ne yapılması gerektiği konusunda herhangi bir açıklama yapmayacağım. Ancak eğitimin ardından hiçbir firar da gelmemelidir. Sadece yolsuzluk olduğu söylendi.</span></p>",
                ],
                'content' => [
                    'en' => 'Text for Blog 1',
                    'ar' => 'نص للمدونة 1',
